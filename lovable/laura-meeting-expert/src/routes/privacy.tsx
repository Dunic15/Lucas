    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          profile. Calendar, Gmail, Drive, Slack, or other workspace access is requested separately
          when you choose to connect that service. We request the narrowest scopes needed for the
      ...
      <section>
        ...
        <p>
          ...
          satisfy legal obligations. The standard product target is 90 days for meeting-derived
          data unless a different setting or agreement applies. Account, security, and billing
          records may be kept longer when required for fraud prevention, accounting, or law.
        </p>
        <p>
