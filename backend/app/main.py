...
from .api import pages, granola, oauth, avatars_api, meetings  # extracted routes
...
from app.api.deps import EMAIL_RE, _split_emails, _calendar_target_emails  # noqa: E402  (hoisted shared helpers)
