...
def build_init_payload(session, avatar) -> dict:
    ...
    prompt = "\n".join(
        [
            ...
            "- Never introduce or continue a topic absent from this meeting's",
            "  current conversation. If the utterance is unclear, stay silent.",
            ...
            "- Frustration, swearing or criticism is NOT a leave request. Do not",
            "  leave unless someone explicitly asks you to leave, exit or drop off.",
