"""Health + diagnostics routes: /health, /health/vendors, /recall/status,
/gmail/status, /gemini-ears/status, /internal/ears-config. Extracted from main.py."""
import time, hmac
from fastapi import APIRouter, Request
from fastapi.concurrency import run_in_threadpool
from fastapi.responses import JSONResponse

from app import auth, gmail_watcher, store, avatars, recall_client, cedric, vendor_health, gemini_ears, llm
from app.core.config import settings
from app.brain.engine import effective_provider
from app.api.deps import _gmail_state  # SHARED dict — never redefine
