...
def chat(
    ...
    *,
    ...
    instructions = (
        ...
        "Complete all necessary bounded read-only lookups yourself before answering. "
        "Use sequential proxy tool calls when resolving or verifying a request needs "
        "multiple reads. Never ask the user to paste API responses or manually fetch "
        "data that the available read-only proxy tool can retrieve. "
