...
lip-sync. Fallback: edge-tts (free, keyless; the page spreads word timings evenly
— approximate lip-sync). Response is JSON either way:
    {"audio": <base64 mp3>, "words": [...]|null, "wtimes": [ms]|null,
     "wdurations": [ms]|null, "engine": "elevenlabs"|"edge", "tts_ms": <int>}

Split out of main.py: this is a self-contained concern with no coupling to the
live meeting path, so it lives behind its own APIRouter.
"""
