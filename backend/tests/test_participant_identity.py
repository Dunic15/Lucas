...
def test_duplicate_names_keep_presentation_names_and_quiet_multiplicity():
    ...
    roster = brain._roster_block(avatar, ["Alex", "Alex"], state)
    assert "Not yet heard from: Alex." in roster

    artifact = brain._finish_artifact({}, state)
    assert artifact["participation"] == [
        {
            "name": "Alex",
            "lines": 1,
            "talk_share": 100,
            "commitments": ["I'll take the security follow-up."],
        }
    ]
