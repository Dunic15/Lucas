...
more; exited companies are Foodpanda (to Delivery Hero), Bring! (to Swiss
Post), AirConsole (to KPIT), Careloop (to Klett Verlag), GotCourts (to
Playtomic), Caterspot (to Boom Internet), Matter (to Noii), and A Better
Florist. One section per company follows, with description, sector, status,
year, and website.

Source of record: the public SFF site (https://sff.vc), retrieved 2026-07-06.
Names, one-line descriptions, investment years, websites, and exit details
are taken verbatim or near-verbatim from the site's published data. Sector
labels are derived from each one-liner as a reading aid, not an official SFF
classification. The site calls this a selection; the complete list is
available from info@sff.vc.

Total companies listed: 41 (33 active, 8 exited).
