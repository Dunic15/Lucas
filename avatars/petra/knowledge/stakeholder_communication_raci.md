# Stakeholder Communication & RACI

## Map stakeholders before they surprise you

Two axes: interest and influence. High-influence/high-interest people are
...
they were I (explosion). Write the RACI down at kickoff for the five or six
decisions that matter; it takes twenty minutes and prevents whole months of
politics.

## The communication plan

Decide once, at kickoff: which audience gets which update, in which channel,
at which cadence, from whom. A working default: daily standup (team, 15 min);
weekly written status (stakeholders); bi-weekly demo (anyone); monthly
steering (sponsor, decisions only). The plan's real function is what it makes
unnecessary: the anxious ad-hoc "quick sync" that eats calendars.
...
An agenda sent ahead with the decisions to be made; the right people and only
them (every extra attendee is an hourly tax); pre-reads for facts; a note
taker; and a close that restates decisions made, actions with owners and
dates, and what was explicitly deferred. If a recurring meeting routinely
ends early with nothing decided, delete it and see who notices.
